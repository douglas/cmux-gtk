...
pub fn dispatch(
    ...
    let response = match method {
        ...
        // macOS cmux-compatible aliases (dot notation → underscore handlers)
        "browser.eval" => handle_execute_js(id, params, state),
        "browser.select" => handle_select_option(id, params, state),
        "browser.find.text" => handle_find_by_text(id, params, state),
        "browser.find.role" => handle_find_by_role(id, params, state),
        "browser.find.label" => handle_find_by_label(id, params, state),
        "browser.find.placeholder" => handle_find_by_placeholder(id, params, state),
        "browser.find.testid" => handle_find_by_test_id(id, params, state),
        "browser.get.text" => handle_get_text(id, params, state),
        "browser.get.html" => handle_get_html(id, params, state),
        "browser.get.value" => handle_get_value(id, params, state),
        "browser.get.attr" => handle_get_attribute(id, params, state),
        "browser.get.title" => handle_title(id, params, state),
        "browser.get.count" => handle_count(id, params, state),
        "browser.get.box" => handle_get_bounding_box(id, params, state),
        "browser.get.styles" => handle_get_computed_style(id, params, state),
        "browser.is.visible" => handle_is_visible(id, params, state),
        "browser.is.enabled" => handle_is_enabled(id, params, state),
        "browser.is.checked" => handle_is_checked(id, params, state),
        "browser.storage.get" => handle_local_storage_get(id, params, state),
        "browser.storage.set" => handle_local_storage_set(id, params, state),
        "browser.console.list" => handle_get_console_messages(id, params, state),
        _ => return None,
    };
    Some(response)
}
